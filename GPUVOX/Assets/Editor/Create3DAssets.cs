...
public class Create3DAssets : MonoBehaviour {
	...
	public void Start () {
        ...
        */
		...
		GetComponent<Renderer>().material.SetVector("g_eyePos", localEyePos);
		GetComponent<Renderer>().material.SetVector("g_lightPos", localLightPos);
		GetComponent<Renderer>().material.SetFloat("g_lightIntensity", _light.intensity);
		GetComponent<Renderer>().material.SetFloat("g_absorption", absorption);
	}
	...
	public void Generate2DTexture()
	{
		...
		texture2D.Apply();
		GetComponent<Renderer>().material.SetTexture("g_tex", texture2D);
	...
	public void Generate3DTexture()
	{
		...
		texture3D.Apply();
		GetComponent<Renderer>().material.SetTexture("g_densityTex", texture3D);
